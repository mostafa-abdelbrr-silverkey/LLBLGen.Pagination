...
namespace LLBLGen.Pagination.Data.FactoryClasses
{
		...
		where TEntity : EntityBase2, IEntity2
	{
		...
		public EntityFactoryBase2(string entityName, LLBLGen.Pagination.Data.EntityType typeOfEntity, bool isInHierarchy) : base(entityName, (int)typeOfEntity)
		{
		...
		/// <inheritdoc/>
		public override IEntity2 CreateEntityFromEntityTypeValue(int entityTypeValue) {	return GeneralEntityFactory.Create((LLBLGen.Pagination.Data.EntityType)entityTypeValue); }
	...
	{
		/// <summary>CTor</summary>
		public CustomerEntityFactory() : base("CustomerEntity", LLBLGen.Pagination.Data.EntityType.CustomerEntity, false) { }
		/// <inheritdoc/>
	...
	{
		/// <summary>CTor</summary>
		public OrderEntityFactory() : base("OrderEntity", LLBLGen.Pagination.Data.EntityType.OrderEntity, false) { }
		/// <inheritdoc/>
	...
	[Serializable]
	public partial class ReceiptEntityFactory : EntityFactoryBase2<ReceiptEntity> 
	{
		/// <summary>CTor</summary>
		public ReceiptEntityFactory() : base("ReceiptEntity", LLBLGen.Pagination.Data.EntityType.ReceiptEntity, false) { }
		/// <inheritdoc/>
		protected override IEntity2 CreateImpl(IEntityFields2 fields) { return new ReceiptEntity(fields); }
	}
	...
	public partial class GeneralEntityFactory
	{
		...
		public static IEntity2 Create(LLBLGen.Pagination.Data.EntityType entityTypeToCreate)
		{
	...
	public static class EntityFactoryFactory
	{
		...
		{
			foreach(int entityTypeValue in Enum.GetValues(typeof(LLBLGen.Pagination.Data.EntityType)))
			{
				var factory = GetFactory((LLBLGen.Pagination.Data.EntityType)entityTypeValue);
		...
		/// <summary>Gets the factory of the entity with the LLBLGen.Pagination.Data.EntityType specified</summary>
		/// <param name="typeOfEntity">The type of entity.</param>
		/// <returns>factory to use or null if not found</returns>
		public static IEntityFactory2 GetFactory(LLBLGen.Pagination.Data.EntityType typeOfEntity)
		{
			switch(typeOfEntity)
			{
				case LLBLGen.Pagination.Data.EntityType.CustomerEntity:
					return new CustomerEntityFactory();
				case LLBLGen.Pagination.Data.EntityType.OrderEntity:
					return new OrderEntityFactory();
				case LLBLGen.Pagination.Data.EntityType.ReceiptEntity:
	...
	{
		/// <summary>Gets the factory of the Entity type with the LLBLGen.Pagination.Data.EntityType value passed in</summary>
		...
		{
			return new DynamicRelation(leftOperand, joinType, (LLBLGen.Pagination.Data.EntityType)Enum.Parse(typeof(LLBLGen.Pagination.Data.EntityType), rightOperandEntityName, false), aliasRightOperand, onClause);
		}

		/// <inheritdoc/>
		public override IDynamicRelation CreateDynamicRelation(string leftOperandEntityName, JoinHint joinType, string rightOperandEntityName, string aliasLeftOperand, string aliasRightOperand, IPredicate onClause)
		{
			return new DynamicRelation((LLBLGen.Pagination.Data.EntityType)Enum.Parse(typeof(LLBLGen.Pagination.Data.EntityType), leftOperandEntityName, false), joinType, (LLBLGen.Pagination.Data.EntityType)Enum.Parse(typeof(LLBLGen.Pagination.Data.EntityType), rightOperandEntityName, false), aliasLeftOperand, aliasRightOperand, onClause);
		}
		
		/// <inheritdoc/>
		public override IDynamicRelation CreateDynamicRelation(IEntityFieldCore leftOperand, JoinHint joinType, string rightOperandEntityName, string aliasLeftOperand, string aliasRightOperand, IPredicate onClause)
		{
			return new DynamicRelation(leftOperand, joinType, (LLBLGen.Pagination.Data.EntityType)Enum.Parse(typeof(LLBLGen.Pagination.Data.EntityType), rightOperandEntityName, false), aliasLeftOperand, aliasRightOperand, onClause);
		}
		
		/// <inheritdoc/>
		protected override IEntityFactoryCore GetFactoryImpl(int entityTypeValue) { return EntityFactoryFactory.GetFactory((LLBLGen.Pagination.Data.EntityType)entityTypeValue); }
