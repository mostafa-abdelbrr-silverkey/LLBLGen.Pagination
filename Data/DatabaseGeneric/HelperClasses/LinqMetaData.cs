...
namespace LLBLGen.Pagination.Data.Linq
{
	...
	public partial class LinqMetaData: ILinqMetaData
	{
		...
		{
			switch((LLBLGen.Pagination.Data.EntityType)typeOfEntity)
			{
		...
		public DataSource2<ReceiptEntity> Receipt {	get { return new DataSource2<ReceiptEntity>(this.AdapterToUse, new ElementCreator(), this.CustomFunctionMappings, this.ContextToUse); } }
