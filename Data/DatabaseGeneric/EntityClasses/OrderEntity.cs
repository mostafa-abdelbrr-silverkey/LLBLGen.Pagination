...
namespace LLBLGen.Pagination.Data.EntityClasses
{
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		protected class OrderEntityStaticMetaData : EntityStaticMetaDataBase
		{
			...
			{
				SetEntityCoreInfo("OrderEntity", InheritanceHierarchyType.None, false, (int)LLBLGen.Pagination.Data.EntityType.OrderEntity, typeof(OrderEntity), typeof(OrderEntityFactory), false);
				AddNavigatorMetaData<OrderEntity, CustomerEntity>("Customer", "Orders", (a, b) => a._customer = b, a => a._customer, (a, b) => a.Customer = b, LLBLGen.Pagination.Data.RelationClasses.StaticOrderRelations.CustomerEntityUsingCustomerIdStatic, ()=>new OrderRelations().CustomerEntityUsingCustomerId, null, new int[] { (int)OrderFieldIndex.CustomerId }, null, true, (int)LLBLGen.Pagination.Data.EntityType.CustomerEntity);
			}
		}
		...
		/// <summary>The IsActive property of the Entity Order<br/><br/></summary>
		/// <remarks>Mapped on  table field: "Order"."IsActive".<br/>Table field type characteristics (type, precision, scale, length): Bit, 0, 0, 0.<br/>Table field behavior characteristics (is nullable, is PK, is identity): false, false, false</remarks>
		public virtual System.Boolean IsActive
		{
			get { return (System.Boolean)GetValue((int)OrderFieldIndex.IsActive, true); }
			set { SetValue((int)OrderFieldIndex.IsActive, value); }
		}

		/// <summary>The Name property of the Entity Order<br/><br/></summary>
		/// <remarks>Mapped on  table field: "Order"."Name".<br/>Table field type characteristics (type, precision, scale, length): NVarChar, 0, 0, 255.<br/>Table field behavior characteristics (is nullable, is PK, is identity): false, false, false</remarks>
		...
		/// <summary>The Price property of the Entity Order<br/><br/></summary>
		/// <remarks>Mapped on  table field: "Order"."Price".<br/>Table field type characteristics (type, precision, scale, length): Int, 10, 0, 0.<br/>Table field behavior characteristics (is nullable, is PK, is identity): false, false, false</remarks>
		public virtual System.Int32 Price
		{
			get { return (System.Int32)GetValue((int)OrderFieldIndex.Price, true); }
			set { SetValue((int)OrderFieldIndex.Price, value); }
		}
